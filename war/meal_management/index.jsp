			...
			<div class="row">
				<div class=" col s3 center-aligned">
					<div class="center-aligned">
						<a class="view-type list-view btn-flat"><i
							class="material-icons prefix input-field">reorder</i></a> <a
							class="view-type grid-view btn-flat blue-text"><i
							class="material-icons prefix input-field">dashboard</i></a>
					</div>
				</div>
				...
				<div
					class="col s3 offset-s3 hide-on-med-and-down right-align add-meal">
					<a id="btn_add_new_meal" data-target="modal_add_new_meal"
						class="btn modal-trigger btn-floating"><i
				...
				<div class="col s12  l6"
					...
					<div class="card small hoverable">
						...
						<div class="card-content">
							...
							<p>
								Calorie Power: {{ meal.CalorieCount }} <span class="unit">{{
									meal.Unit }}</span>
							</p>
						...
						<div class="card-reveal">
							<div class="row reveal-row">
								<span
									class="card-title text-size-16 grey-text text-darken-4 row">
									<i class="col s9">{{ meal.MealName }}</i> <i
									class="material-icons right col s3">close</i>
								</span>
								<div class="description">
									<p>{{ meal.Description }}</p>
								</div>
							</div>
							<a class="waves-effect waves-light btn btn-floating right"><i
								class="material-icons left">add</i></a>
						</div>
					</div>
				</div>
				<div class="center-align no-meals"
					ng-hide="(meals | filter: global.search).length">No Meals
					Found</div>
			</div>
		</div>
